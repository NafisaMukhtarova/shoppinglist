...
//продукты из списка
$result_shopping_list_1 = $pdo->prepare("SELECT B.product_name AS product_name, C.category_name AS category_name, A.shopping_list_id AS id, A.bought AS bought, A.price AS price
...
$result_shopping_list_2 = $pdo->prepare("SELECT A.item AS product_name, 'нет категории' AS category_name, A.shopping_list_id AS id , A.bought AS bought, A.price AS price
